...
const Tag = React.forwardRef(({ className, content, size, onCancel, onSelectTag, ...props }, ref) => ((0, jsx_runtime_1.jsx)("div", { className: "w-[200px]", children: (0, jsx_runtime_1.jsxs)(LabelPrimitive.Root, { onClick: onSelectTag ?? undefined, ref: ref, className: (0, utils_1.cn)(TagVariants({ size, className })), ...props, children: [content, onCancel && (0, jsx_runtime_1.jsx)(react_icons_1.Cross1Icon, { onClick: onCancel })] }) })));
