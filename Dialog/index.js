...
function Dialog(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("dialog", { id: "my_modal_2", className: "modal", open: checked, children: [(0, jsx_runtime_1.jsx)("input", { ref: ref, className: "hidden", type: "checkbox", checked: checked, onChange: (e) => {
                ...
                } }), (0, jsx_runtime_1.jsx)("form", { method: "dialog", className: "modal-box dark:bg-white", children: content }), (0, jsx_runtime_1.jsx)("form", { method: "dialog", className: "modal-backdrop bg-[rgba(30,35,52,0.24)] backdrop-blur-sm", onClick: () => setChecked(false) })] }));
}
