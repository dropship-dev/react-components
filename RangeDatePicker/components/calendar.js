...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return ((0, jsx_runtime_1.jsx)(react_day_picker_1.DayPicker, { showOutsideDays: showOutsideDays, className: (0, utils_1.cn)("px-6 py-5", className), classNames: {
            ...
            caption_label: "text-[16px] leading-6 font-medium text-black pb-2",
            ...
            head_row: "flex",
            head_cell: "text-gray-900 w-12 flex justify-center font-normal text-[14px]",
            row: "flex w-full mt-2",
            cell: "text-center text-[14px] p-0 relative [&:has([aria-selected])]:bg-neutral-100 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
            day: "h-12 w-12 p-0 font-normal rounded-full aria-selected:opacity-100",
