...
function MultiplechoiceSelect(props) {
    const { data, optionTop, width, onCheckedChange, onClear, callbackListSelected, content, defaultValue, callbackAllSelected, } = props;
