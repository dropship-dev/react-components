...
function MultiplechoiceSelect(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: width, children: (0, jsx_runtime_1.jsxs)(popover_1.Popover, { open: open, onOpenChange: (e) => setOpen(e), children: [(0, jsx_runtime_1.jsx)(popover_1.PopoverTrigger, { asChild: true, onClick: () => setOpen(true), children: (0, jsx_runtime_1.jsx)(__1.Input, { value: value, readOnly: true, className: width }) }), (0, jsx_runtime_1.jsxs)(popover_1.PopoverContent, { className: `p-0 ${width}`, children: [optionTop?.length > 0 &&
                            optionTop.map((item) => {
