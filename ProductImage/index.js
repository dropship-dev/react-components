...
const SkeletonLoading_1 = require("../SkeletonLoading");
...
const statusVariant = (0, class_variance_authority_1.cva)("rounded-full z-20 absolute bottom-0 right-0 border-[2px] border-white", {
    variants: {
        size: {
            xs: "w-[6px] h-[6px]",
            sm: "w-[8px] h-[8px]",
