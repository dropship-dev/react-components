...
const alertVariants = (0, class_variance_authority_1.cva)("w-[372px] px-6 pt-4 pb-6 rounded-[12px] fixed top-0 right-6", {
    variants: variants,
});
...
const Alert = React.forwardRef(({ status, content, disabled, onCancel, className, header, open, ...props }) => {
