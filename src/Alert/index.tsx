...
const alertContent = cva("text-[14px] leading-[20px] fontWeight-400", {
        ...
        className={cn(
          `${
            openAlert
              ...
              : "transition-all ease-in-out duration-800 transform translate-x-[396px]"
          }`,
          alertVariants({
            status,
          })
        ...
        <div className="flex justify-between flex-row">
          <div className="translate-[-11px]">
            {status === "success" ? (
              ...
              >
                <g clipPath="url(#clip0_1451_66321)">
                  <circle
                    cx="21"
                    cy="21"
                    r="20.25"
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_1126_66740)">
                  <circle
                    cx="21.5"
                    cy="21"
                    r="20.25"
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_1451_66286)">
                  <circle
                    cx="21"
                    cy="21"
                    r="20.25"
