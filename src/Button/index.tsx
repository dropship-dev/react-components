...
const buttonVariants = cva(
  "inline-flex items-center font-semibold justify-center rounded-md text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-background",
  {
    variants: {
      bgColor: {
        primary:
          "bg-primary-500 hover:bg-primary-400 active:bg-primary-500 border-primary-500 focus:shadow-[#EAECF0] focus:shadow-[0_0_0_4px] text-white",
        destructive:
          "bg-destructive-500 hover:bg-destructive-600 active:bg-destructive-400 border-destructive-400 focus:shadow-[#FDE4F2] focus:shadow-[0_0_0_4px] text-white",
        // danger:
        ...
        secondary:
          "bg-primary-25 hover:bg-primary-50 active:bg-primary-100 focus:shadow-[#DBDDFF] border-primary-500 focus:shadow-[0_0_0_4px] text-primary-500",
        normal:
          "bg-white hover:bg-gray-100 focus:bg-gray-200 active:bg-gray-300 border-gray-400 focus:shadow-[#EAECF0] focus:shadow-[0_0_0_4px] text-black",
        // normalPrimary:
  ...
  "inline-flex items-center font-semibold justify-center rounded-md text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-background",
  {
    variants: {
      bgColor: {
        ...
        normal:
          "bg-inherit hover:bg-gray-100 focus:bg-gray-200 active:bg-gray-300 border-gray-400 focus:shadow-[#EAECF0] text-black",
      },
